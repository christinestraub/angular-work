angular.module('snapshotApp')
  .controller('HistoryCompareCtrl', function ($uibModalInstance, $http, first, second) {
    var $ctrl = this;
    ...
    $http.get(`/api/archives/${$ctrl.first.uuid}`).then(response => {
      $ctrl.cur_archive = response.data;
      $http.get(`/api/archives/${$ctrl.second.uuid}`).then(response => {
